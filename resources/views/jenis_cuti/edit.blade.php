...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchJenisCuti() {
        try {
            const response = await fetch(`/api/jenis-cuti/${jenisCutiId}`, {
                method: 'GET',
                headers: {
            ...
            showErrorAlert('Gagal mengambil data jenis cuti');
        }
    }
    ...
    resetButton.addEventListener('click', async function() {
        const result = await Swal.fire({
            ...
            text: 'Apakah Anda yakin ingin mengembalikan ke data semula?',
            icon: 'warning',
    ...
    jenisCutiForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            await showSuccessAlert('Jenis cuti berhasil diperbarui');
            redirectToIndex();
