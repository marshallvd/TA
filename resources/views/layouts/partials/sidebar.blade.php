    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('pegawai.index') }}" role="button" aria-expanded="false" aria-controls="sidebar-user">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-maps" data-bs-parent="#sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('cuti_pribadi.index') }}">
                               <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon"> V </i>
                                <span class="item-name">Cuti Pribadi</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('cuti.kalender') }}">
                               <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                        <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon"> V </i>
                                <span class="item-name">Kalender Cuti Pegawai</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#penilaian-kinerja" role="button" aria-expanded="false" aria-controls="penilaian-kinerja">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
