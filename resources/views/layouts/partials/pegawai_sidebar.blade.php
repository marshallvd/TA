...
<aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all on-resize ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="{{ route('dashboard.pegawai') }}" class="navbar-brand">
            <!--Logo start-->
            <!--logo End-->
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{ route('dashboard.pegawai') }}">
                        <i class="icon">
                ...
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled" href="#" tabindex="-1">
                        <span class="default-icon">Pegawai</span>
                        <span class="mini-icon">-</span>
                    </a>
                </li>
                {{--  --}}
                ...
                <li class="nav-item static-item">
                    <a class="nav-link static-item disabled" href="#" tabindex="-1">
                        <span class="default-icon">Tambahan</span>
                        <span class="mini-icon">-</span>
                    </a>
                </li>
                {{-- <li class="nav-item">
