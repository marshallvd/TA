            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Daftar Divisi</h4>
                        <a href="{{ route('master_data.divisi.create') }}" class="btn btn-primary">
                            <i class="bi bi-plus-square me-2"></i>Tambah Divisi
                        </a>
                    </div>
                </div>
                <div class="card-body">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const table = $('#divisi-table').DataTable({
        processing: true,
        serverSide: false,
        responsive: true,
        ajax: {
                        ...
                        actions: `
                            <div class="flex align-items-center list-user-action">
                                <a class="btn btn-sm btn-icon btn-warning" 
                                   ...
                                   title="Edit" 
                                    href="/master_data/divisi/${item.id_divisi}/edit">
                                ...
                                <a class="btn btn-sm btn-icon btn-danger delete-divisi" 
                                   data-bs-toggle="tooltip" 
                                   data-bs-placement="top" 
                                   title="Delete" 
    ...
    document.addEventListener('click', function(e) {
        const deleteButton = e.target.closest('.delete-divisi');
        if (!deleteButton) return;

        e.preventDefault();
        const divisiId = deleteButton.dataset.id;
