            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Daftar Komponen Core Values</h4>
                    </div>
                    <div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const table = $('#core-values-table').DataTable({
        processing: true,
        serverSide: false,
        ajax: {
            ...
            dataSrc: function(response) {
                ...
                return response.data.map((item, index) => ({
                    DT_RowIndex: index + 1,
                    nama_core_values: item.nama_core_values || '-',
                    bobot: item.bobot || '-',
                    perilaku_utama: item.perilaku_utama || '-',
                    actions: `
                        <div class="flex align-items-center list-user-action">
                            <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="{{ url('komponen-penilaian/core-values/edit') }}/${item.id_komponen_core_values}">
                            ...
                            <a class="btn btn-sm btn-icon btn-danger delete-core-values" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" data-id="${item.id_komponen_core_values}" href="javascript:void(0)">
                                <span class="btn-inner">
        ...
        columns: [
            ...
            { data: 'nama_core_values', name: 'nama_core_values' },
    ...
    // Delete handler using Fetch
    document.addEventListener('click', function(e) {
        if (e.target.closest('.delete-core-values')) {
            e.preventDefault();
            const deleteButton = e.target.closest('.delete-core-values');
            const coreValuesId = deleteButton.dataset.id;
            
            Swal.fire({
                title: 'Apakah Anda yakin?',
                text: "Data Core Values yang dihapus tidak dapat dikembalikan!",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    .then(() => {
                        Swal.fire(
                            'Terhapus!',
                            'Data Core Values berhasil dihapus.',
                            'success'
                        );
                        table.ajax.reload();
                    })
    ...
    // Refresh token handler using Fetch
    ...
    // Add global fetch error handler if needed
