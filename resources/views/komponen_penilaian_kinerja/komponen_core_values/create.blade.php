            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="new-user-info">
                        <form id="coreValuesForm" class="needs-validation" novalidate>
                            <div class="row">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const coreValuesForm = document.getElementById('coreValuesForm');
    ...
    coreValuesForm.addEventListener('submit', async function(e) {
        e.preventDefault();
