            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Tambah Komponen Core Values Baru</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="new-user-info">
                        <form id="createCoreValuesForm" class="needs-validation" novalidate>
                            <div class="row g-4">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const createForm = document.getElementById('createCoreValuesForm');
    ...
    resetButton.addEventListener('click', function() {
        Swal.fire({
            title: 'Reset Form?',
            text: 'Anda akan mengembalikan form ke keadaan kosong',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Form Direset',
                    text: 'Form telah dikembalikan ke keadaan kosong',
                    timer: 1500,
    ...
    createForm.addEventListener('submit', async function(e) {
        ...
        // Basic validation
        const namaCoreValues = document.getElementById('nama_core_values').value.trim();
        const bobot = parseFloat(document.getElementById('bobot').value);
        const perilakuUtama = document.getElementById('perilaku_utama').value.trim();
        ...
        const data = {
            nama_core_values: namaCoreValues,
            bobot: bobot,
            perilaku_utama: perilakuUtama
        };
        ...
        try {
            ...
            await Swal.fire({
                icon: 'success',
                title: 'Berhasil!',
                text: 'Komponen core values berhasil ditambahkan',
                allowOutsideClick: false
            });
